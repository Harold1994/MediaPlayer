...
public class VideoPlayer extends AppCompatActivity {
        ...
        if(this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
            ...
            if(cursor != null){
                if(cursor.getCount() > 0){
                    ...
                    TextView create = (TextView) findViewById(R.id.video_create_time);
                    create.setText(item.createdTime);
                    ...
                    TextView create = (TextView) findViewById(R.id.video_create_time);
                    create.setText(R.string.unknown);
    ...
    private void exit(){
        Toast.makeText(this, R.string.no_playing_target,Toast.LENGTH_LONG).show();
        finish();
    }
